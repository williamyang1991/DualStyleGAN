...
- [09/2022] Pre-trained models in three [styles](#comabine-dualstylegan-with-state-of-the-art-diffusion-model) (feat. StableDiffusion) are released. 
...
Trained with these images, DualStyleGAN is able to pastiche these famous artists and generate appealing results.
